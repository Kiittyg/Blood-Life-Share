...
<head>
    ...
    <style>
        ...
        .logo img {
            width: 190px; /* Ajuste la taille du logo */
        }
...
<div class="container">
    <div class="logo">
        <img src="images/is.jpg" alt="Logo">
    </div>
    <form action="{{ route('enregistrer.lignerv') }}" method="POST">
        @csrf
        <input type="hidden" name="demandedon_id" value="{{ $demandedon_id }}">
