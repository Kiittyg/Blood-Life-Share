    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="video-gallery-item">
                    <div class="image-holder">
                        <img src="images/gallery/Ca.png" class="img-responsive" alt="video-gallery">
                        <a data-fancybox href="https://www.youtube.com/watch?v=trEo0OYSl9Q&pp=ygUYc2F1dmUgcGFyIGxlIGRvbiBkZSBzYW5n"><i class="fa fa-play"></i></a>
                    </div>
                    <h3></h3>
                </div>
            </div>
            <div class="col-sm-6">
                <div class="video-gallery-item">
                    <div class="image-holder">
                        <img src="images/gallery/Capture.PNG" class="img-responsive" alt="video-gallery">
                        <a data-fancybox href="https://www.youtube.com/watch?v=_KSkXK0rj2Q&pp=ygUYc2F1dmUgcGFyIGxlIGRvbiBkZSBzYW5n">
            ...
            <div class="col-sm-6">
                <div class="video-gallery-item">
                    <div class="image-holder">
                        <img src="images/gallery/C.PNG" class="img-responsive" alt="video-gallery">
                        <a data-fancybox href="https://www.youtube.com/watch?v=UwYZsldqWdU&pp=ygUgc2F1dmUgcGFyIGxlIGRvbiBkZSBzYW5nIHNlbmVnYWw%3D">
                            <i class="fa fa-play"></i>
                        </a>
                    </div>
                    <h3></h3>
            ...
            <div class="col-sm-6">
                <div class="video-gallery-item">
                    <div class="image-holder">
                        <img src="images/gallery/Cap.PNG" class="img-responsive" alt="video-gallery">
                        <a data-fancybox href="https://www.youtube.com/watch?v=imrYSU5QMmU&pp=ygUYcG91cnF1b2kgZG9ubmVyIHNvbiBzYW5n">
                            <i class="fa fa-play"></i>
                        </a>
                    </div>
                    <h3></h3>
